...
def word():
    ...
    for i in words:
        if i=="room1" or i=="Room1":
            ...
            os.system("python /home/mrstark/vithack/room1.py")
            speak("reached room one")
        if i=="room2" or i=="Room2":
            speak("going to room two")
            os.system("python /home/mrstark/vithack/room2.py")
            speak("reached room two")
        if i=="kitchen" or i=="Kitchen":
            speak("going to kitchen")
            os.system("python /home/mrstark/vithack/kitchen.py")
            speak("reached kitchen")
        if i=="hall" or i=="Hall":
            speak("going to hall")
            os.system("python /home/mrstark/vithack/hall.py")
            speak("reached hall")
        if i=="charging" or i=="Charging":
            speak("going to cahrging port")
            os.system("python /home/mrstark/vithack/charging.py")
...
def respond(voice_data):
    if there_exists(['hey','hi','hello']):
        greetings = ["hey, how can I help you ", "hey, what's up?", "how can I help you? ", "hello "]
        greet = greetings[random.randint(0,len(greetings)-1)]
        speak(greet)
    
    if there_exists(['Thankyou','thankyou','thanks','Thanks','Thank you','thank you']):
        speak("no mention i am there for you")
        print(voice_data)
